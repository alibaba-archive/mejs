...
Template.prototype.compile = function () {
  this.generateSource()
  var src = 'var ctx = this, __output = [], __append = __output.push.bind(__output);\n  '
...
Template.prototype.parseTemplateText = function () {
  ...
  var openClearTag = this.openTag + '_'
  var closeClearTag = '_' + this.closeTag
  str = str
  ...
  var closeTags = [this.closeTag, '-' + this.closeTag, '_' + this.closeTag]
  var openLiteralTag = this.openTag + this.delimiter
...
function createReg (delimiter) {
  var delim = _REGEX_STRING.replace(/%/g, escapeRegChars(delimiter))
