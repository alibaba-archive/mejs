...
var mejsTpl = fs.readFileSync(path.join(__dirname, 'mejs.js'), {encoding: 'utf8'})
var tplsTpl = fs.readFileSync(path.join(__dirname, 'tpls.js'), {encoding: 'utf8'})
